...
public class PurchaseController {
	...
	@GetMapping("/portfolio/purchase/{accountId}")
	public ResponseEntity< PortfolioDetailsResponseDto> getById(int id) throws ManagementException, PortfolioNotFoundException{
